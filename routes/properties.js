...
import { propertysData } from '../data/index.js';

router
    .route('/')
    .get(async (req, res) => {
        try {
            let propertyList = await propertysData.getAllProperty();
    ...
    .post(async (req, res) => {
        ...
        try {
            const newProperty = await propertysData.createProperty(
                propertyInfo.userId,
...
router
    ...
    .get(async (req, res) => {
        ...
        try {
            let property = await propertysData.getPropertyById(req.params.id);
            res.json(property);
        } catch (e) {
    ...
    .put(async (req, res) => {
        ...
        try {
            const updatedProperty = await propertysData.updatePropertyPut(
                req.params.id,
                propertyInfo.propertyName,
                propertyInfo.description,
                propertyInfo.numberOfRooms,
    ...
    .patch(async (req, res) => {
        ...
        try {
            const updatedProperty = await propertysData.updatePropertyPatch(
                req.params.id,
                propertyInfo
            );
    ...
    .delete(async (req, res) => {
        ...
        try {
            let deletedProperty = await propertysData.removePropertyById(req.params.id);
